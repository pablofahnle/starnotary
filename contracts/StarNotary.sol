...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Pablo Star Token";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        require(
            ...
            "No token is owned by the sender"
        );
        address owner_star_1 = ownerOf(_tokenId1);
        address owner_star_2 = ownerOf(_tokenId1);
        _transferFrom(owner_star_1, owner_star_2, _tokenId1);
        _transferFrom(owner_star_2, owner_star_1, _tokenId2);
